...
def main():
    ...
    # If attached to a TTY, allow single-key toggle with 'm'. Otherwise, fall back to reading lines ("TOGGLE").
    if sys.stdin.isatty():
        def listen_for_keys():
            fd = sys.stdin.fileno()
        ...
        # Non-interactive mode: read commands like "TOGGLE" from stdin
